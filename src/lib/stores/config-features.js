export const config = {
	mapTitle: 'map-happiness-state-of-democracy', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-happiness-state-of-democracy.vercel.app/', // The url provided when deploying the map on Vercel
